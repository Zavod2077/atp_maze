class GameScene extends Phaser.Scene{
	...
	init(){
		...
		this.spots =JSON.parse(JSON.stringify([{xx:402,y:195,number:0},{x:408,y:355,number:3},{x:484,y:128,number:2},{x:475,y:82,number:1},{x:826,y:55,number:3},{x:683,y:311,number:1},{x:652,y:356,number:2},{x:616,y:423,number:3},{x:617,y:475,number:0},{x:606,y:554,number:3},{x:476,y:476,number:2},{x:892,y:484,number:3}]));
